...
#initial_condition_drones = np.array([[20, -20, 10], [-12, -16, 10], [15, -18, 25]])
#initial_condition_drones = np.array([[-10, 0, 10]])
initial_condition_drones = np.array([[-10, 0, 50], [18, 4, 50], [-30, -15, 50], [34, -28, 30], [20, 20, 20], [30, 15, 10]])
...
#target_trajectories = [3, 2]
target_trajectories = [2, 5, 7]
